  ...
  topics: [
    ...
    },
    {
      ...
      instructions: [
        ...
        'Comment out, but do not delete, your HTML for the individual skills from the HTML/CSS lessons.  You will reference your commented code in JavaScript Part 2.',
